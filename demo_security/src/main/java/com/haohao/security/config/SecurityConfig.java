...
import com.haohao.security.service.impl.SecUserServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    final SecUserServiceImpl secUserService;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(secUserService).passwordEncoder(encoder());
    }
