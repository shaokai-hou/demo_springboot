...
import com.haohao.security.exception.BaseException;
...
public class CustomAccessDecisionService {
    ...
    public boolean hasPermission(String permission) {
        ...
        CustomUserDetails userDetailsInfo = getCustomUserDetailsInfo();
     ...
     */
    private CustomUserDetails getCustomUserDetailsInfo() {
